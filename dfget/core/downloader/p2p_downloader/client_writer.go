...
type PieceWriter interface {
	...
	PostRun(response *types.PullPieceTaskResponse, ctx context.Context) error
...
func (cw *ClientWriter) PostRun(response *types.PullPieceTaskResponse, ctx context.Context) (err error) {
